<template>
  <div class="w-full h-auto bg-white py-6">
    ...
    >
      <a-button type="primary" size="large">创建比赛</a-button>
    </header>
    <main class="box-border px-10">
      <div class="my-8 bg-gray-300 p-6 box-border rounded-md">
      ...
      <div v-show="current > 0" class="min-h-[400px]">
